            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-primary text-white text-center">
                        <h4 class="mb-0">Mettre à jour l'idée</h4>
                    </div>
                    <div class="card-body">
                        @if (session('status'))
                    ...
                    @endif
                        ...
                        <form method="post" action="{{route('idees.update', $idee->id)}}" class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="email" class="form-control  @error('email') is-invalid @enderror" id="bookTitle" name="email"  value="{{$idee->email}}"  required>
                                @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control  @error('libelle') is-invalid @enderror" id="publisher" name="libelle" required  value="{{$idee->libelle}}" >
                                @error('libelle')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            </div>
                            <div class="col-12">
                                ...
                                <textarea name="description" id="description"  class="form-control  @error('description') is-invalid @enderror" >{{$idee->description}}</textarea>
                                @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            </div>
                            ...
                            <div class="col-12 text-center">
                                <button type="submit" class="btn btn-primary">Mettre à jour l'idée Idée</button>
                            </div>
                        </form>
                    </div>
                </div>
